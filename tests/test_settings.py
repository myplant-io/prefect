...
SUPPORTED_SETTINGS = {
    ...
    "PREFECT_SERVER_DOCKET_WORKER_MAX_RESTART_ATTEMPTS": {"test_value": 0},
    "PREFECT_SERVER_DOCKET_WORKER_RECONNECT_BASE_DELAY_SECONDS": {"test_value": 1.0},
    "PREFECT_SERVER_DOCKET_WORKER_RECONNECT_MAX_DELAY_SECONDS": {"test_value": 30.0},
